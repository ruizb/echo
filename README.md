...
If you wish to add a new statement to the "noise tolerance" form, you can add it to the `statement` list from the [`noiseToleranceForm.ts`](https://github.com/ruizb/echo/blob/master/src/client/views/noiseToleranceForm.ts) file:
