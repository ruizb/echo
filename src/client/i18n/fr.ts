const translations = {
  ...
  userInfo_hypersensibilityImpactNotAtAll: `Pas du tout`,
  userInfo_hypersensibilityImpactALittle: `Un peu`,
  userInfo_hypersensibilityImpactModerately: `Modérément`,
  userInfo_hypersensibilityImpactALot: `Beaucoup`,
